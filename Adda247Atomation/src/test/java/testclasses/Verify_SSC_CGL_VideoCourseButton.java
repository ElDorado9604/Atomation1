...
public class Verify_SSC_CGL_VideoCourseButton {
	...
	public static void main(String[] args) throws InterruptedException, EncryptedDocumentException, IOException {
		...
		if(url.equals("https://www.adda247.com/ssc-cgl/videos-kit") 
				&& title.equals("SSC CGL Video Lectures 2021 : Join & Prepare with SSC CGL Video Course by Adda247."))
		{
